...
When you use the `/exchange` command, the data that you input (including currency codes and amounts) will be sent to [Frankfurter](https://frankfurter.dev), [Wise](https://wise.com), [Revolut](https://revolut.com), [Visa](https://www.visa.com/), and [Mastercard](https://www.mastercard.com/).
